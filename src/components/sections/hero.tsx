  ...
  return (
    <Container id="hero">
      <div className="flex flex-col gap-12 md:flex-row">
        {/* Image */}
        <div className="relativeflex items-center justify-center md:order-last md:flex-grow md:justify-end">
          <div className="relative isolate h-[300px] w-[280px] md:h-[360px] md:w-[320px]">
            ...
            ></Image>
            <div className="absolute z-0 h-[280px] w-[280px] border-8 border-transparent bg-gray-200 max-md:top-5 md:bottom-0 md:right-0 md:h-[320px] md:w-[280px]"></div>
          </div>
        </div>
        ...
        <div className="flex max-w-3xl flex-grow flex-col justify-center gap-8 md:order-first md:items-start md:justify-center 2xl:gap-12">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex gap-2">
              ...
              <Typography>Rennes, France</Typography>
            </div>
